...
export const EditPost = props => {
    ...
    setDate("");
       ...
       axios.put(`/editors/update/${props.match.params.id}`, formData )
    ...
    useEffect(() => {
        ...
        .then(res => [
            ...
            setSpeakerName(res.data.speaker_name),
     ...
     <AddItemContainer>
            ...
            <div className="header-page">
                <div className="main-info">
                    <div className="topic">
                    <h1> Update Conference</h1></div>
                </div>
            </div>

        <div className="container">
        <div className="topic">
         <h1 style={{textAlign:"center"}}>Update Post</h1></div>
            ...
            <div className="form-group">
                <label htmlFor="speaker_name" >Speaker's Name</label>
                <input type="text" 
                value={speaker_name}
            ...
            <div className="button" style={{textAlign:"center", color:"#"}} ><button 
